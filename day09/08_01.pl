  ...
  my $ops = {
    ...
    '8' => {
      ...
      'ins' => sub {
        ...
        if ( v($HW,$code,1) == v($HW,$code,2) ) {
          #$code->[$code->[$HW->{'i'} + 3]] = 1;
          $code->[a($HW,$code,3)] = 1;
          say 'STE true: ',a($HW,$code,3),'=',$code->[a($HW,$code,3)];
        }
        else {
          #$code->[$code->[$HW->{'i'} + 3]] = 0;
          $code->[a($HW,$code,3)] = 0;
          say 'STE false: ',a($HW,$code,3),'=',$code->[a($HW,$code,3)];
        }
        $HW->{'i'} += 4;
      }
    },
    '9' => {
      ...
      'ins' => sub {
        ...
        say 'new base: ',$HW->{'base'},' value: ',$value;
        $HW->{'i'} += 2;
      }
    },
   '99' => {
